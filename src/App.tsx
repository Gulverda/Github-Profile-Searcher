        ...
        <ProfileInfo>
          <Head>
            ...
            <Names>
              ...
              <UserLink href={`https://github.com/${profileData.profile.login}`} target="_blank" rel="noopener noreferrer">
                @{profileData.profile.pseudoName}
              </UserLink>
            </Names>
            <p>Joined: {profileData.profile.joinDate}</p>
          </Head>
          <LeftForFollow>
            <ContainerForFollow>
            ...
            <p><svg width="14" height="20" viewBox="0 0 14 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                {profileData.profile.location}</p>
